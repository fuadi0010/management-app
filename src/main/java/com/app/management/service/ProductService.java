...
public class ProductService {
    ...
    // Method untuk memproses pembelian product (penambahan stok dan update harga beli)
    ...
    // Method untuk mencari dan mengurutkan product berdasarkan keyword, status, dan parameter sorting
